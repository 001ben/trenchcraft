...
3. **Improve contact feel.** Stop the linkage from passing through uncut soil, add resistance/flow sharing, tune bucket geometry and keep scoop/dump particles attached to the correct location. Replace rigid decorative hydraulic rods with linkages whose piston lengths follow both attachment points.
